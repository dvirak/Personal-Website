export default function Experience() {
  return (
    <section className="resume__section section">
      <h2 className="resume__section__title">{`Technical Skills`}</h2>
      <div className="resume__container container">
        <ul>
          <li>
            <b>Languages:</b> Javascript, SQL, HTML5, CSS, Python
          </li>
          <li>
            <b>Framkeworks and Libraries:</b> React.js, Node.js, Express.js,
            Bootstrap, jQuery
          </li>
          <li>
            <b>Tools and Platforms:</b> Git, GitHub, Postman
          </li>
          <li>
      ...
      <h2 className="resume__section__title">{`Technical Projects`}</h2>
      <div className="resume__container container">
        <ul>
          <li className="resume__job__title resume__line">
            <span className="resume__text-left-side">
              <b>MyStack </b>| Project Lead/Backend Engineer
            </span>
            <span className="resume__text-right-side">May 2024 - Present</span>
          </li>
          <li>
            <a
              href="https://github.com/dvirak/comicCompendium"
              target="_blank"
          ...
          <li className="resume__job__title resume__line">
            <span className="resume__text-left-side">
              <b>Danazon </b>| Lead Developer
            </span>
            <span className="resume__text-right-side">
              November 2023 - February 2024
            </span>
          </li>
          <li>
            <a
              href="https://danazon.netlify.app/"
              target="_blank"
              rel="noopener noreferrer"
            >
              Danazon.com
      ...
      <div className="resume__container container">
        <ul>
          ...
          <li className="resume__job__title resume__line">
            ...
            <span className="resume__text-right-side">May 2015</span>
          </li>
          <li>
            <i>Bachelor of Science in Business</i>
          </li>
          <li className="resume__job__title resume__line">
            <span className="resume__text-left-side">
              <b>IBM Data Analysis Professional Certificate</b>
            </span>
      ...
      <div className="resume__container container">
        <ul>
          <li className="resume__job__title resume__line">
            <span className="resume__text-left-side">
              <b>Dairy Manager</b> | Publix Supermarkets | Richmond, VA
            </span>
            <span className="resume__text-right-side">July 2023 - Present</span>
          </li>
          <li>
            <ul className="resume__job-list">
              <li>
          ...
          <li className="resume__job__title resume__line">
            <span className="resume__text-left-side">
              <b>Grocery Manager</b> | Publix Supermarkets | Richmond, VA
            </span>
            <span className="resume__text-right-side">
          ...
          <li className="resume__job__title resume__line">
            <span className="resume__text-left-side">
              <b>Assistant Grocery Manager</b> | Publix Supermarkets | Richmond,
              VA
            </span>
            <span className="resume__text-right-side">
          ...
          <li className="resume__job__title resume__line">
            <span className="resume__text-left-side">
              <b>Grocery Team Lead</b> | Publix Supermarkets | Richmond, VA
            </span>
            <span className="resume__text-right-side">
          ...
          <li className="resume__job__title resume__line">
            <span className="resume__text-left-side">
              <b>Wine Specialist</b> | Publix Supermarkets | Richmond, VA
            </span>
            <span className="resume__text-right-side">
          ...
          <li className="resume__job__title resume__line">
            <span className="resume__text-left-side">
              <b>F&B Supervisor</b> | Searbook Island Club | Charleston, SC
            </span>
            <span className="resume__text-right-side">
          ...
          <li className="resume__job__title resume__line">
            <span className="resume__text-left-side">
              <b>F&B Management Intern</b> | Seabrook Island Club | Seabrook
              Island, SC
            </span>
            <span className="resume__text-right-side">
